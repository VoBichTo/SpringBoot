package com.infotech.ticket.entities;
...
public class Ticket {
	...
	public String toString() {
		return "Ticket [ticketId=" + tiketId + ", passengerName=" + passengerName + ", bookingDate=" + bookingDate
				+ ", sourceStation=" + sourceStation + ", destStation=" + desStation + ", email=" + email + "]";
	}
